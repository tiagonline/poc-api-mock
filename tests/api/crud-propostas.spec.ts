...
test.describe.serial('CRUD - Ciclo de Vida da Proposta de Seguro', () => {
  ...
  test('Passo 1: [POST] Deve criar uma nova proposta de seguro', async ({ request }) => {
  ...
  test('Passo 3: [PATCH] Deve atualizar o status da proposta', async ({ request }) => {
  ...
  test('Exceção: [GET] Deve tratar Erro 500 do servidor gracefully', async ({ request }) => {
